...
- (void)viewDidLoad {
    ...
    WCCycleScrollView *cycleView = [WCCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 100, width, 150) delegate:self placeholderImage:[UIImage imageNamed:@"h6"]];
    ...
    cycleView.imageViewContentMode = UIViewContentModeScaleAspectFill;
//    cycleView.titleGroup = @[@"这是第一张",@"这是第二张",@"这是第三张",@"这是第四张"];
//    cycleView.currentPageImage = [UIImage imageNamed:@"pageControlCurrentDot"];
//    cycleView.pageImage = [UIImage imageNamed:@"pageControlDot"];
